...
class ActivityService
{
    public function store(array $data): array
    {
        ...
        // Check working days
        $workingDays = WorkDay::where('officer_id', $data['officer_id'])->pluck('day_of_week')->toArray() ?? [];
        ...
        $workingTime = Officer::where('id', $data['officer_id'])
        ...
        // Activity overlap logic (unchanged)
        $existingActivities = Activity::where('officer_id', $data['officer_id'])
        ...
        foreach ($existingActivities as $activity) {
            ...
            // main villain (different dates): left for the future
        }
